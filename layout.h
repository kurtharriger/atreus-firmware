...
#define FN_NORMALMODE      PRE_FUNCTION(4)
#define FN_LOCKCTRL        PRE_FUNCTION(5)
#define FN_LOCKSHIFT       PRE_FUNCTION(6)
#define FN_LOCKALT         PRE_FUNCTION(7)
#define FN_LOCKGUI         PRE_FUNCTION(8)
...
int layer0[44] = {
    ...
    FN_RESET, KEY_TAB, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEY_MINUS, KEY_QUOTE, KEY_ENTER };
...
int layer1[44] = {
    ...
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEY_PERIOD, KEY_0, KEY_EQUAL };
...
int layer2[44] = {
    ...
    LAYER(0), 0, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), 0, FUNCTION(0), KEY_ENTER };

int layer3[44] = {
    0, 0, 0, 0, 0, KEY_0, GUI(KEY_TAB), KEY_HOME, KEY_UP, KEY_PAGE_UP, GUI(KEY_TILDE), 
    FN_LOCKCTRL, FN_LOCKALT, FN_LOCKGUI, FN_LOCKSHIFT, 0, KEY_0, KEY_DELETE, KEY_LEFT, KEY_DOWN, KEY_RIGHT, KEY_BACKSPACE,
    0, 0, 0, 0, 0, FUNCTION(3), SHIFT(GUI(KEY_TAB)), KEY_END, KEY_DOWN, KEY_PAGE_DOWN, SHIFT(GUI(KEY_TILDE)), 
    0, 0, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, FUNCTION(3), LAYER(0), LAYER(1), LAYER(2), 0, KEY_ENTER };
