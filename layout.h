...
int layer0[44] = {
    ...
    KEY_ESC, KEY_TAB, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, LAYER(1), KEY_MINUS, KEY_QUOTE, KEY_ENTER };
...
int layer1[44] = {
    ...
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, LAYER(0), FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, LAYER(1), KEY_PERIOD, KEY_0, KEY_EQUAL };
...
int layer2[44] = {
    ...
    LAYER(0), 0, KEYBOARD_LEFT_GUI, LAYER(0), FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, LAYER(1), 0, FN_RESET, KEY_ENTER };
...
int layer3[44] = {
    ...
    0, LAYER(2), LAYER(1), LAYER(0), FN_NORMALMODE, FUNCTION(3), LAYER(0), LAYER(1), LAYER(2), FN_RESET, KEY_ENTER };
