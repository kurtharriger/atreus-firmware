...
int layer1[44] = {
    ...
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, LAYER(3), KEYBOARD_LEFT_CTRL, LAYER(0), FN_ACTIVATE_FN, KEY_0, KEY_PERIOD, KEY_EQUAL };
...
int layer3[44] = {
    KEY_ESC, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEYBOARD_LEFT_GUI, KEY_0, KEY_TAB, KEY_HOME, KEY_UP, KEY_PAGE_UP, GUI(KEY_TILDE),
    0, 0, 0, 0, 0, KEY_0, KEY_BACKSPACE, KEY_LEFT, KEY_DOWN, KEY_RIGHT, KEY_DELETE,
    GUI(KEY_Z), GUI(KEY_X), GUI(KEY_C), GUI(KEY_V), KEYBOARD_LEFT_ALT, FUNCTION(3), 0, KEY_END, KEY_DOWN, KEY_PAGE_DOWN, KEY_SLASH,
