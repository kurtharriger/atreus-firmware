...
#define FN_NORMALMODE      FUNCTION(4)
...
int layer0[44] = {
    ...
    KEY_ESC, KEY_TAB, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEY_MINUS, KEY_QUOTE, KEY_ENTER };
...
int layer2[44] = {
    ...
    LAYER(0), 0, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, FN_NORMALMODE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), 0, FN_RESET, KEY_ENTER };

int layer3[44] = {
    0, 0, 0, 0, 0, KEY_0, GUI(KEY_TAB), KEY_HOME, KEY_UP, KEY_PAGE_UP, GUI(KEY_TILDE),
    FN_LOCKCTRL, FN_LOCKALT, FN_LOCKGUI, FN_LOCKSHIFT, 0, KEY_0, KEY_BACKSPACE, KEY_LEFT, KEY_DOWN, KEY_RIGHT, KEY_DELETE,
    0,GUI(KEY_X), GUI(KEY_C), GUI(KEY_V), 0, FUNCTION(3), SHIFT(GUI(KEY_TAB)), KEY_END, KEY_DOWN, KEY_PAGE_DOWN, SHIFT(GUI(KEY_TILDE)),
    0, LAYER(2), LAYER(1), LAYER(0), FN_NORMALMODE, FUNCTION(3), LAYER(0), PRE_FUNCTION(1), LAYER(2), FN_RESET, KEY_ENTER };
